...
namespace MCB
{
	...
	public:
		...
		void SetVertexBuffer(const D3D12_HEAP_TYPE& heaptype,const D3D12_RESOURCE_DIMENSION& dimension, const uint32_t& sizeVB, const int32_t& height, const int32_t& DepthOrArraySize, const int32_t& MipLevels, const int32_t& SampleDescCount, const D3D12_TEXTURE_LAYOUT& layout);
